...
export function Chat({
  ...
  const handleResearchComplete = useCallback(
    (report: string) => {
      // Phase 3 v2.0: Direct display, no auto-send to AI
      // The report is displayed in ResearchProgress component
      // User can optionally choose to "Share with AI" later
